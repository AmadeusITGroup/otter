...
description: Import and use external OpenAPI models from npm packages. Use when you need to add, install, or reference models from external libraries, reuse shared models across projects, or include dependencies containing OpenAPI specifications.
---
...
1. Inspect installed NPM packages with OpenAPI-related keywords: <!-- This keywords list comes from the constant OPENAPI_NPM_KEYWORDS exposed by the package @ama-openapi/core -->
   - `openapi`
   - `openapi-model`
   - `openapi-spec`
   - `swagger`
