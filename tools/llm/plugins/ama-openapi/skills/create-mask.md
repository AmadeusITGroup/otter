---
name: create-mask
description: Create or configure field masks to expose only specific fields from OpenAPI models. Use when you need to hide sensitive fields, reduce payload size, or create different views (public/internal) of models by configuring transforms.masks in openapi.manifest.json.
---
