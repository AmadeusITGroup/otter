...
- `updateSassImports` is deprecated.</br>Note: *Legacy migration: `@import "~@o3r/styling"` / `"~@otter/styling"` -> `@use`.*

### From [apps/vscode-extension/src/commands/extract/styling/extract-all-to-variable-command.ts](https://npmjs.com/package/apps/vscode-extension/src/commands/extract/styling/extract-all-to-variable-command.ts)

- `extractAllToVariable` is deprecated.</br>Note: *Rely on Design Token extraction instead.*

### From [apps/vscode-extension/src/commands/extract/styling/extract-to-variable-command.ts](https://npmjs.com/package/apps/vscode-extension/src/commands/extract/styling/extract-to-variable-command.ts)

- `extractToVariable` is deprecated.</br>Note: *Rely on Design Token extraction instead.*

### From [apps/vscode-extension/src/commands/generate/enrich-component/theming-to-component-commands.ts](https://npmjs.com/package/apps/vscode-extension/src/commands/generate/enrich-component/theming-to-component-commands.ts)

- `generateAddThemingToComponentCommand` is deprecated.</br>Note: *Rely on Design Token strategy.*

### From [apps/vscode-extension/src/intellisense/styling.ts](https://npmjs.com/package/apps/vscode-extension/src/intellisense/styling.ts)

- `stylingCompletionItemProvider` is deprecated.</br>Note: *Will rely on native CSS Variable completion.*
- `stylingCompletionTriggerChar` is deprecated.</br>Note: *Will rely on native CSS Variable completion.*
