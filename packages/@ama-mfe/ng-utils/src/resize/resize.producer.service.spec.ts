...
describe('ResizeService', () => {
  ...
  let messageService: MessagePeerService<ResizeVersions>;
  ...
  beforeEach(() => {
    ...
    messageService = TestBed.inject(MessagePeerService<ResizeVersions>);
  ...
  it('should send resize message via messageService when body height changes', () => {
    ...
    runInInjectionContext(injector, () => {
      ...
      // eslint-disable-next-line no-undef -- available in test env
  ...
  it('should handle errors', () => {
    ...
    const errorMessage: ErrorContent<ResizeVersions> = { reason: 'unknown_type', source: { type: 'resize', version: '1.0', height: 0 } };
