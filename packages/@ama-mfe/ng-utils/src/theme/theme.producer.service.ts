...
export class ThemeProducerService implements MessageProducer<ThemeVersions> {
  private readonly messageService = inject(MessagePeerService<ThemeVersions>);
   ...
   */
  public readonly types = MESSAGE_THEME_TYPE;
  ...
  constructor() {
    ...
    effect(() => {
      ...
      if (themeObj && themeObj.css !== null) {
        ...
        // TODO: broadcastBest() is not yet implemented
  ...
  /**
   * Handles errors related to theme messages.
   * @param message - The error message content.
   */
  public handleError(message: ErrorContent<Theme>): void {
