...
describe('ActivityProducerService', () => {
  ...
  beforeEach(() => {
    ...
    connectionServiceMock = {
      ...
      id: 'test-module',
      knownPeers: new Map([
        ['nevio-cockpit', [{ type: USER_ACTIVITY_MESSAGE_TYPE, version: '1.0' }]],
  ...
  describe('handleError', () => {
    it('should log warning for error messages', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Error in user activity service message', errorContent);
  ...
  describe('peer filtering', () => {
    ...
    it('should send to multiple peers that have registered for user activity', fakeAsync(() => {
      ...
      expect(callArgs.to).toContain('nevio-cockpit');
