 ...
 */
export const ACTIVITY_EVENTS: UserActivityEventType[] = [
  'click',
  'keydown',
  'scroll',
  'touchstart',
 ...
 */
export const HIGH_FREQUENCY_EVENTS: UserActivityEventType[] = [
  'scroll'
];
 ...
 */
export const DEFAULT_ACTIVITY_PRODUCER_CONFIG: ActivityProducerConfig = {
