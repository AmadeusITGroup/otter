      ...
      switchMap((navStartEvent) => {
        return this.router.events.pipe(
          ...
          map(({ urlAfterRedirects }) => {
            ...
            return ({ url: currentRouteRegExp ? urlAfterRedirects.replace(currentRouteRegExp, '') : urlAfterRedirects, channelId: navStartEvent.restoredState?.channelId as string | undefined });
          })
        );
      })
