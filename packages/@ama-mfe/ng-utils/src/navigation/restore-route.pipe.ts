...
export class RestoreRoute implements PipeTransform {
   ...
   */
  public transform(url: string | SafeResourceUrl | undefined, options?: Partial<RestoreRouteOptions>): SafeResourceUrl | undefined {
    if (!url) {
      return undefined;
    }
    ...
    if (urlString) {
      ...
      return this.domSanitizer.bypassSecurityTrustResourceUrl(moduleUrl.toString());
    }
