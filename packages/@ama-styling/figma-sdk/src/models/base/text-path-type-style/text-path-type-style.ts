...
import { TextPathTypeStyleBoundVariables } from '../text-path-type-style-bound-variables';

export interface TextPathTypeStyle {
  ...
  /** @see TextPathTypeStyleBoundVariables */
  boundVariables?: TextPathTypeStyleBoundVariables;
}
