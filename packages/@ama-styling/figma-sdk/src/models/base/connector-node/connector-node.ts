...
import { ConnectorEndpoint } from '../connector-endpoint';
import { ConnectorLineType } from '../connector-line-type';
import { ConnectorTextBackground } from '../connector-text-background';
...
export interface ConnectorNode {
  ...
  strokeDashes?: number[];
  /** @see ConnectorEndpoint */
  connectorStart: ConnectorEndpoint;
  /** @see ConnectorEndpoint */
  connectorEnd: ConnectorEndpoint;
  /** A string enum describing the end cap of the start of the connector. */
  connectorStartStrokeCap: ConnectorStartStrokeCapEnum;
  /** A string enum describing the end cap of the end of the connector. */
  connectorEndStrokeCap: ConnectorEndStrokeCapEnum;
  /** @see ConnectorLineType */
  connectorLineType: ConnectorLineType;
  /** @see ConnectorTextBackground */
  textBackground?: ConnectorTextBackground;
}

export type TypeEnum = 'CONNECTOR';
