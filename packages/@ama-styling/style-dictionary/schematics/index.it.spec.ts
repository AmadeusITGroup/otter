 ...
 * @jest-environment-o3r-app-folder test-app-ama-style-dictionary
 */
...
describe('ng add otter style-dictionary hooks', () => {
  test('should add style-dictionary to an application', async () => {
    ...
    expect(() => packageManagerExec({ script: 'ng', args: ['add', `@ama-styling/style-dictionary@${o3rVersion}`, '--skip-confirmation', '--project-name', appName] }, execAppOptions)).not.toThrow();
  ...
  test('should add style-dictionary to a library', async () => {
    ...
    expect(() => packageManagerExec({ script: 'ng', args: ['add', `@ama-styling/style-dictionary@${o3rVersion}`, '--skip-confirmation', '--project-name', libName] }, execAppOptions)).not.toThrow();
    expect(() => packageManagerInstall(execAppOptions)).not.toThrow();
