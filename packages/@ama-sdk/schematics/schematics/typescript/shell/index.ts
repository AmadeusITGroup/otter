...
function ngGenerateTypescriptSDKFn(options: NgGenerateTypescriptSDKShellSchematicsSchema): Rule {
  ...
  const setupRule = async (tree: Tree, context: SchematicContext) => {
    ...
    const versions = {
      ...
      '@stylistic/eslint-plugin-js': amaSdkSchematicsPackageJson.devDependencies!['@stylistic/eslint-plugin-js'],
    ...
    const properties = {
      ...
      angularEslintVersion: amaSdkSchematicsPackageJson.devDependencies!['angular-eslint'],
      versions,
