import { Formatter } from '../core/formatters/formatter.interface';
import { JsonFormatter } from '../core/formatters/json-formatter';
import { SplitYamlFormatter } from '../core/formatters/split-yaml-formatter';
import { YamlFormatter } from '../core/formatters/yaml-formatter';
import { SwaggerSpecMerger } from '../core/swagger-spec-merger';
import { SwaggerSpecSplit } from '../core/swagger-spec-wrappers/swagger-spec-split';
import { getCurrentArtifactVersion, getTargetInformation } from '../core/utils';
import { BuilderApiConfiguration } from '../interfaces/apis-configuration';
import { BuilderConfiguration, OutputFormat } from '../interfaces/builder-configuration';
import { applyPostProcess } from './post-process';
