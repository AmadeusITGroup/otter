...
public class LambdaHelper {
  ...
  public static class UrlParamReplacerLambda extends CustomLambda {
      ...
      @Override
      public String formatFragment(String fragment) {
          return fragment.replaceAll("\\{([\\w_-]+)\\}", "\\${$1}");
      }

  }

  public static class SanitizeFieldNameLambda extends CustomLambda {

    public SanitizeFieldNameLambda() {}
  ...
  public static class removeEqualsNullLambda extends CustomLambda {

    public removeEqualsNullLambda() {}

    @Override
    public String formatFragment(String fragment) {
        return fragment
          .replaceAll(" *= *(const)? *null", "");
    }
  ...
  public static class LowerCaseLambda extends CustomLambda {
