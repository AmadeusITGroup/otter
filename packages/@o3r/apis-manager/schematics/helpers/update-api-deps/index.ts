...
import { getAppModuleFilePath, getProjectFromTree, ngAddPackages } from '@o3r/schematics';
...
export function apiManagerFactory(): ApiManager {
  ...
  return chain([
    updateTsConfig,
    updateAppModule,
    ngAddPackages(['@ama-sdk/core'], {skipConfirmation: true, parentPackageInfo: '@o3r/apis-manager'})
  ]);
}
