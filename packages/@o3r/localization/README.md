...
> [!WARNING]
> ngx-translate will no longer be supported in Otter v16. Please migrate to [`@o3r/transloco`](https://www.npmjs.com/package/@o3r/transloco), which is based on [JSVerse Transloco](https://github.com/jsverse/transloco).
