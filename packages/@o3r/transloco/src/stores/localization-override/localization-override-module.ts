...
/**
 * Provide the LocalizationOverride store for the application.
...
export function provideLocalizationOverrideStore(reducerFactory?: () => ActionReducer<LocalizationOverrideState, Action>): EnvironmentProviders {
  return makeEnvironmentProviders([
    ...
    { provide: LOCALIZATION_OVERRIDE_REDUCER_TOKEN, useFactory: reducerFactory || (() => localizationOverrideReducer) }
  ]);
}
