...
program
  ...
  .option('-t, --last-downloaded-time-value <numberOfDays>', 'This is to be used if you which to pass a different value than durationKept for the download part', /[0-9]+/)
