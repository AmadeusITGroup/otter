import {extractPackageLine, extractPackages, formatGitBranchOutput, verifyBranches} from './helpers';

describe('helpers', () => {
  it('verifyBranches should sort release array properly', () => {
    expect(verifyBranches([])).toEqual([]);
    expect(verifyBranches(['release/1.2', 'release/2.2', 'release/3.2'])).toEqual(['release/1.2', 'release/2.2', 'release/3.2']);
    expect(verifyBranches(['release/1.2', 'release/0.1', 'release/3.1', 'release/0.4']))
      .toEqual(['release/0.1', 'release/0.4', 'release/1.2', 'release/3.1']);
    expect(verifyBranches(['release/3.0.0-next', 'release/2.5.0-alpha', 'release/1.2', 'release/2.4', 'release/0.1']))
  ...
  it('formatGitBranchOutput', () => {
    ...
    expect(formatGitBranchOutput(fakeOutput)).toEqual(['release/0.1', 'release/1.2', 'release/2.4', 'release/2.5.0-alpha', 'release/3.0.0-next']);
  });
