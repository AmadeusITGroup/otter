...
import type { RulesetExecutionDebug } from '../ruleset-history/ruleset-history-pres.component';
 ...
 * @param isActive
 */
export const getStatus = (rulesetExecution: RulesetExecutionErrorEvent | RulesetExecutionEvent, isActive: boolean): 'Error' | 'Active' | 'Deactivated' | 'NoEffect' => {
