...
function ngAddFn(options: NgAddSchematicsSchema): Rule {
  ...
  return async (tree, context) => {
    const { getExternalDependenciesInfo, getPackageInstallConfig, getProjectNewDependenciesTypes, setupDependencies, getO3rPeerDeps, getWorkspaceConfig, removePackages } = await import('@o3r/schematics');
