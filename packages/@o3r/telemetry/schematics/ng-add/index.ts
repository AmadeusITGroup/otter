...
export function ngAdd(_options: NgAddSchematicsSchema): Rule {
  return (tree, context) => {
    if (tree.exists('/package.json')) {
      ...
      ((packageJson.config as JsonObject).o3r as JsonObject).telemetry = true;
...
You can deactivate it at any time by changing 'config.o3r.telemetry' in 'package.json' or by setting 'O3R_METRICS' to false as environment variable.
