...
describe('ng add testing', () => {
  test('should add testing to an application', () => {
    ...
    expect(diff.added).toContain(path.join(relativeApplicationPath, 'jest.config.js'));
    expect(diff.added).toContain(path.join(relativeApplicationPath, 'testing', 'setup-jest.ts'));
    expect(diff.added).toContain(path.join(relativeApplicationPath, 'e2e-playwright', 'playwright-config.ts'));
    expect(diff.added).toContain(path.join(relativeApplicationPath, 'e2e-playwright', 'empty-test.e2e.ts'));
