...
import {
  addPlaywrightFilesToEslintProject,
      ...
      const rules = [
        ...
        ...installPlaywright
          ? [
            ...
            ...isEslintInstalled ? [addPlaywrightFilesToEslintProject(workingDirectory)] : []
          ]
          : [],
        ...installJest ? [setupJest({ ...options, eslintSetupRequired: isEslintInstalled })] : [],
