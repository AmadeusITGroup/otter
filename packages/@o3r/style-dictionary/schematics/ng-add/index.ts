...
function ngAddFn(options: NgAddSchematicsSchema): Rule {
  ...
  const updatePackageJson: Rule = (tree, context) => {
    ...
    if (packageJson.scripts['generate:css']) {
      ...
      packageJson.scripts['generate:css'] = 'style-dictionary build -c config.mjs -p css';
    }
    if (packageJson.scripts['generate:metadata']) {
      ...
      packageJson.scripts['generate:metadata'] = 'style-dictionary build -c config.mjs -p cms';
    }
