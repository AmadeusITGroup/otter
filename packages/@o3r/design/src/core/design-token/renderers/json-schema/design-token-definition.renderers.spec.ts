...
import { getJsonSchemaTokenDefinitionRenderer } from './design-token-definition.renderers';
...
describe('getMetadataTokenDefinitionRenderer', () => {
  ...
  test('should rely on given tokenValueRenderer', () => {
    ...
    const renderer = getJsonSchemaTokenDefinitionRenderer({ tokenValueRenderer });
  ...
  test('should render valid JSON object', () => {
    const renderer = getJsonSchemaTokenDefinitionRenderer();
    const variable = designTokens.get('example.var1');
