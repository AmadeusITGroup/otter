...
| --------------------------- | ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| **language**                | 'css'*Require*   | Type of the variables to generate for a Design Token. *(`css`, `scss` and `sass` are available)*                                         |
...
| **renderPrivateVariableTo** | *null*           | Generate the Private Variable to the given language (if not specified, in case of CSS, the variable will be ignored in generated style). |
