export const syncEntityReducerSpecContent = `import * as actions from './air-offers.actions';
...
describe('AirOffers Store reducer', () => {
  ...
  describe('Actions on state details ', () => {
    ...
    it('SET action should clear current cart state details and return a state with the new one', () => {
      const firstState = airOffersReducer(entitiesState, actions.setAirOffers({stateDetails: {}}));
  ...
  describe('Entity actions', () => {
    ...
    it('CLEAR_ENTITIES action should clear only the entities', () => {
      ...
      const secondState = airOffersReducer(firstState,
        actions.setAirOffers({stateDetails: {}}));
