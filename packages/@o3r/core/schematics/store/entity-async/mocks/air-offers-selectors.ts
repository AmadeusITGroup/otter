export const asyncEntitySelectorsContent = `import {createFeatureSelector, createSelector} from '@ngrx/store';
...
export const selectAirOffersStorePendingStatus = createSelector(selectAirOffersState, (state) => state.isPending || false);
`;
