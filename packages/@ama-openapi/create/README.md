...
| Options | Description |
| --- | --- |
| `--target`, `-t` | Target directory to generate the files into. |
...
> - **Package management**: Pre-configured package.json with common scripts
> - **Renovate Configuration**: extending the [@ama-openapi/core preset](ttps://github.com/AmadeusITGroup/otter/tree/main/packages/@ama-openapi/core/renovate/default.json)

## Integration

This generator setup the repository to work with:
