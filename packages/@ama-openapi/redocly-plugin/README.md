...
> [!TIP]
> Find the documentation regarding the package managing strategy on [Node Package Manager](https://github.com/AmadeusITGroup/otter/tree/main/packages/@ama-openapi/core#dependency-resolution-concept).\
...
A full documentation regarding the masking of specified information is accessible on the [OpenAPI Masking configuration](https://github.com/AmadeusITGroup/otter/tree/main/packages/@ama-openapi/core#manifest-configuration).\
...
As the plugin required to be executed a the initiation of the Redocly process, the configuration of the plugin should be provided via [Environment Variable](https://en.wikipedia.org/wiki/Environment_variable).

The following environment are supported:

| Environment Variable | Description | Default Value |
| --- | --- | --- |
| `AMA_OPENAPI_REDOCLY_NO_BAIL` | Ignore process failure and continue Redocly process | `false` |
...
- [@ama-openapi/cli](https://www.npmjs.com/package/@ama-openapi/cli) - Command to retrieve manually the dependencies
