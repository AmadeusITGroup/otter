...
import { ChangeDetectionStrategy, ChangeDetectorRef, Component, EventEmitter, forwardRef, inject, Input, type OnDestroy, type OnInit, Output, ViewEncapsulation } from '@angular/core';
import {
  AbstractControl,
...
import { ControlFlatErrors, CustomFormValidation, FlatError, getFlatControlErrors, markAllControlsDirtyAndTouched } from '@o3r/forms';
import { Localization, LocalizationModule, Translatable } from '@o3r/localization';
import { Subscription } from 'rxjs';
import { PersonalInfo } from '../../showcase/forms-parent/contracts';
import { DatePickerInputPresComponent } from '../date-picker-input';
import { FormsPersonalInfoPresConfig } from './forms-personal-info-pres.config';
import { FormsPersonalInfoPresTranslation, translations } from './forms-personal-info-pres.translation';
