...
@Component({
  ...
  templateUrl: './date-picker-input-hebrew-pres.html',
  styleUrls: ['./date-picker-input-hebrew-pres.scss'],
  providers: [
    NgbCalendarHebrew,
    NgbDatepickerI18nHebrew,
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => DatePickerHebrewInputPres),
      multi: true
    },
...
export class DatePickerHebrewInputPres implements ControlValueAccessor, DatePickerInputHebrewPresContext {
