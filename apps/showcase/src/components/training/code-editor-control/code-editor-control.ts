...
@Component({
  ...
  templateUrl: './code-editor-control.html',
  styleUrl: './code-editor-control.scss'
})
export class CodeEditorControl implements OnDestroy, AfterViewInit {
  /**
   * Show the terminal used as output for the command process
   */
  public showOutput = input(true);
