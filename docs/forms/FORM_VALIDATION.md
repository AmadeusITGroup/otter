[Form validators](#form-validators)
   1. [Sync Validators](#sync-validators)
       1. [Container/presenter context](#container-presenter)
          1. [Basic validators](#basic-validators)
             ...
             3. [Validators translations](#translation-validators)
          2. [Custom validators](#custom-validators)
             ...
             3. [Validators translations](#custom-translation-validators)
             4. [Custom validation contracts](#custom-validators-context)  
   2. [Async Validators](#async-validators)
...
```
[__CustomFormValidation__](https://github.com/amadeus-digital/Otter/blob/main/packages/@o3r/forms/src/core/custom-validation.ts) is containing two entries, one for global (root) form validation and one for the other fields.  
