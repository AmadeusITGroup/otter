[Form errors](#introduction)
   1. [Form error store](#store)
      1. [Error object model](#errormodel)
   2. [Creating error object](#creteerror) 
      1. [Custom errors](#customerrors)  
      2. [Basic/primitive errors](#basicerrors)  
      3. [Build error messages](#builderror)  
   3. [Display inline error messages](#inlineerror)   
      1. [Basic errors](#inlinebasicerror)  
      2. [Custom errors](#inlinecustomerror)
   4. [Add errors to the store](#adderrortostore)   
   5. [Errors translation definition](#errorstranslation)
      1. [Custom errors](#translationcustomerror)  
      2. [Primitive errors](#translationbasicerror)   
...
The store is provided in __@o3r/forms__ package. See [Form Error Store](https://github.com/amadeus-digital/Otter/blob/main/packages/@o3r/forms/src/stores/form-error-messages/form-error-messages.state.ts) for more details and state object model.   
<a name="errormodel"></a>
#### Error object model
...
#### Custom errors
They are returned by __custom validators__ and have the type [CustomErrors](https://github.com/amadeus-digital/Otter/blob/main/packages/@o3r/forms/src/core/custom-validation.ts) defined in __@o3r/forms__.
...
We put in place a generic helper [__getFlatControlErrors__](https://github.com/amadeus-digital/Otter/blob/main/packages/%40o3r/forms/src/core/helpers.ts) in __@o3r/forms__. 
This gets a flattened list of all the errors in the form and it's descendants, concatenating the __custom errors__; The object returned by the helper has [ControlFlatErrors](https://github.com/amadeus-digital/Otter/blob/main/packages/%40o3r/forms/src/core/flat-error.ts) type.
```typescript
/**
