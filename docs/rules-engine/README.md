...
It may include optional conditions to enable or disable the whole Ruleset based on simple triggers such as the date
of execution of the Ruleset (validityRange) or the presence of specific components in the page (see 
[linked components](./how-to-use/dedicated-component-ruleset.md)).<br>
If any of the rules belonging to the same ruleset fail due to an error, none of the resulting actions from any of these
