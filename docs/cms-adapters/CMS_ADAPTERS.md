...
In the previous example, you should include the output of the aggregate in the packaged application instead if the original migration scripts (`./migration-scripts/dist` instead of `./mìgration-scripts/src`).
