...
- Install `@o3r/transloco` via ng-add
...
If you were using `MESSAGE_FORMAT_CONFIG` from `@o3r/localization`, it's no longer needed with the new Transloco-based implementation:
...
**After:**
```typescript
// Remove MESSAGE_FORMAT_CONFIG provider
